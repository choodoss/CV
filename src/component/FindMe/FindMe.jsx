    ...
    return (
        <Container>
            ...
            <List className={openMenu ? "open" : "close"}>
                <Item><LinkItem target="_blank" href="https://www.instagram.com/dmytro_khomenko/"><FiExternalLink style={{ fontSize: "16px" }} /> <span>Instagram account</span> </LinkItem></Item>
                <Item><LinkItem target="_blank" href="https://www.facebook.com/dim4a" ><FiExternalLink style={{ fontSize: "16px" }} /> <span>Facebook account</span> </LinkItem></Item>
